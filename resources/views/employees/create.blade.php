...
<div class="gz-card-head" style="margin-bottom: 1rem;">
    <div>
        ...
        <p class="gz-section-lede mb-0">
            @if ($isEdit)
                {{ __('Cập nhật thông tin lương, BHXH và người phụ thuộc — áp dụng cho các kỳ lương từ tháng hiện tại.') }}
            @else
                {{ __('Khai báo thông tin căn bản, lương cố định và bảo hiểm để bắt đầu tính lương hàng tháng.') }}
            @endif
        </p>
    </div>
